...
class test_vt_abnormal_008(common.sensemediaTestBase):

    def __init__(self):
        super(test_vt_abnormal_008, self).__init__("test_vt_abnormal_008")
    ...
    def test_001(self):
        ...
        resp_message = r_body.get("error_msg")
        ...
        if resp_message != "Request url is invalid":
            self.logger.error("resp_message content : %s  is not as expect  ,pls check！" % str(resp_message))
            assert False
