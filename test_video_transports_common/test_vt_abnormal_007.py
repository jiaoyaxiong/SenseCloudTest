...
class test_vt_abnormal_007(common.sensemediaTestBase):

    def __init__(self):
        super(test_vt_abnormal_007, self).__init__("test_vt_abnormal_007")
    ...
    def test_001(self):
        ...
        if resp_message != "Incorrect request parameters: url and stream is conflict":
