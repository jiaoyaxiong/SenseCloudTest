...
class test_vm_normal_019(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_019, self).__init__("test_vm_normal_019")
        ...
        self.body = {
            ...
            "token": self.token,
            "modules": "filter_celebrity,filter_celebrity"
        }
        # 请求头
