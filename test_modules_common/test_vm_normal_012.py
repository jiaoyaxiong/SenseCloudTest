...
class test_vm_normal_012(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_012, self).__init__("test_vm_normal_012")
        ...
        #期望使用的modules
        self.expect_modules=["scene_detect",]
        #probability 最低限度
