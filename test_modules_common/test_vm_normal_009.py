...
class test_vm_normal_009(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_009, self).__init__("test_vm_normal_009")
        ...
        #期望使用的modules
        self.expect_modules=["image_search",]
        #probability 最低限度
