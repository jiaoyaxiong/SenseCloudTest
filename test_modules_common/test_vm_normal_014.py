...
class test_vm_normal_014(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_014, self).__init__("test_vm_normal_014")
        ...
        #期望使用的modules
        self.expect_modules=["logo_detect",]
        #probability 最低限度
