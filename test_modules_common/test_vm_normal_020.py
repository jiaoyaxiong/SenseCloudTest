...
class test_vm_normal_020(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_020, self).__init__("test_vm_normal_020")
        ...
        self.body = {
            ...
            "token": self.token,
            "modules": "filter_celebrity:12,filter_celebrity:500"
        }
        # 请求头
