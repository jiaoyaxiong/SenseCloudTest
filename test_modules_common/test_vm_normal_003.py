...
class test_vm_normal_003(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_003, self).__init__("test_vm_normal_003")
        ...
        #期望使用的modules
        self.expect_modules=["filter_terror",]
        #probability 最低限度
