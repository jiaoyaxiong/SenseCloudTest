...
class test_vm_abnormal_003(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_abnormal_003, self).__init__("test_vm_abnormal_003")
        ...
        self.body = {
            ...
            "token": self.token,
            "modules":"filter_celebrity,bucunzai"
        }
        # 请求头
