...
class test_vm_normal_010(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_010, self).__init__("test_vm_normal_010")
        ...
        #期望使用的modules
        self.expect_modules=["cloth_detect",]
        #probability 最低限度
