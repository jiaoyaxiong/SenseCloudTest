...
class test_vm_normal_015(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_015, self).__init__("test_vm_normal_015")
        ...
        self.body = {
            ...
            "token": self.token,
            "modules": "filter_celebrity,object_detect"
        }
        # 请求头
        ...
        #期望使用的modules
        self.expect_modules=["filter_celebrity","object_detect"]
        #probability 最低限度
