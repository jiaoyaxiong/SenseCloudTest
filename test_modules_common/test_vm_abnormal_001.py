...
class test_vm_abnormal_001(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_abnormal_001, self).__init__("test_vm_abnormal_001")
