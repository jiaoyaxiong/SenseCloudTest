...
class test_vm_normal_013(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_013, self).__init__("test_vm_normal_013")
        ...
        #期望使用的modules
        self.expect_modules=["event_detect",]
        #probability 最低限度
