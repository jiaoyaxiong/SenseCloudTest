...
class test_vm_normal_005(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_005, self).__init__("test_vm_normal_005")
        ...
        #期望使用的modules
        self.expect_modules=["filter_celebrity_attr",]
        #probability 最低限度
