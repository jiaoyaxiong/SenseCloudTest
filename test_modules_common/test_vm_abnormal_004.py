...
class test_vm_abnormal_004(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_abnormal_004, self).__init__("test_vm_abnormal_004")
        ...
        self.body = {
            ...
            "token": self.token,
            "modules":"filter_celebrity:111,filter_celebrity:0.02"
        }
        # 请求头
        ...
        #期望使用的modules
        self.expect_modules=["filter_celebrity:213",]
        #probability 最低限度
