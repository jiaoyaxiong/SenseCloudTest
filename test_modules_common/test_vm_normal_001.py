...
class test_vm_normal_001(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_001, self).__init__("test_vm_normal_001")
        ...
        self.body = {
            ...
            "token": self.token,
            "modules": "filter_celebrity,filter_terror,filter_celebrity,filter_celebrity_attr,filter_ad,ocr,face_search,image_search,cloth_detect,object_detect,scene_detect,event_detect,logo_detect"
        }
        # 请求头
