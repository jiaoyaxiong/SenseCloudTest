...
class test_vm_normal_008(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_008, self).__init__("test_vm_normal_008")
        ...
        #期望使用的modules
        self.expect_modules=["face_search",]
        #probability 最低限度
