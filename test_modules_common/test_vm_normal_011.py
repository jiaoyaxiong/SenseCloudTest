...
class test_vm_normal_011(common.sensemediaTestBase):

    def __init__(self):
        super(test_vm_normal_011, self).__init__("test_vm_normal_011")
        ...
        #期望使用的modules
        self.expect_modules=["object_detect",]
        #probability 最低限度
