...
class test_abnormal_005(common.sensemediaTestBase):

    def __init__(self):
        super(test_abnormal_005, self).__init__("test_abnormal_005")
        ...
        # 请求体
        self.body = {
            "url": [self.video_url,self.video_url,],
    ...
    def test_001(self):
        ...
        if r.json().get("error_msg") != "Part name is not exists: name is ":
            assert False
