...
class test_video_abnormal_001(common.sensemediaTestBase):

    def __init__(self):
        super(test_video_abnormal_001, self).__init__("test_video_abnormal_001")
    ...
    def test_001(self):
        ...
        if r.json().get("error_msg") != "File type is not support":
            self.logger.error("error code should be File type is not support")
