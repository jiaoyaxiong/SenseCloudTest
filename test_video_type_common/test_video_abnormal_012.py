...
class test_video_abnormal_012(common.sensemediaTestBase):

    def __init__(self):
        super(test_video_abnormal_012, self).__init__("test_video_abnormal_012")
        ...
        self.stream = "rtsp://asdasdasd.asdasd"
