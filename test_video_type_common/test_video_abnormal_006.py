...
class test_video_abnormal_006(common.sensemediaTestBase):

    def __init__(self):
        super(test_video_abnormal_006, self).__init__("test_video_abnormal_006")
        ...
        self.stream = "rtsp://172.20.8.15:8081/test.ts"
