...
"""
用例名字：test_video_normal_002
测试目的：测试最大size的MP4视频是否可以分析
...
class test_video_normal_002(common.sensemediaTestBase):

    def __init__(self):
        super(test_video_normal_002, self).__init__("test_video_normal_002")
