...
class test_video_abnormal_002(common.sensemediaTestBase):

    def __init__(self):
        super(test_video_abnormal_002, self).__init__("test_video_abnormal_002")
        ...
        # TODO
        self.video_url = "http://172.20.8.15:90/renmingdemingyi.avi"
        self.stream = ""
    ...
    def test_001(self):
        ...
        if r.json().get("error_msg") != "File type is not support":
            self.logger.error("error_msg should be File type is not support")
            assert False
