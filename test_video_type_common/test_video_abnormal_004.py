...
class test_video_abnormal_004(common.sensemediaTestBase):

    def __init__(self):
        super(test_video_abnormal_004, self).__init__("test_video_abnormal_004")
        ...
        self.stream = "rtsp://172.20.8.15:8081/123.tss"
