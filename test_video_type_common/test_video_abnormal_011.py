...
class test_video_abnormal_011(common.sensemediaTestBase):

    def __init__(self):
        super(test_video_abnormal_011, self).__init__("test_video_abnormal_011")
