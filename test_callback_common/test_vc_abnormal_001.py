...
class test_vc_abnormal_001(common.sensemediaTestBase):

    def __init__(self):
        super(test_vc_abnormal_001, self).__init__("test_vc_abnormal_001")
        ...
        self.modules = ""
        self.callback = "hp://172.20.23.42:22222/callback"
