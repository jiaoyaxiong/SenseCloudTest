...
# class test_vf_normal_001(common.sensemediaTestBase):
#
#     def __init__(self):
#         super(test_vf_normal_001, self).__init__("test_vf_normal_001")
...
#         self.logger.info("self.ids_2 is %s "% self.ids_2 )
#
#
#
#
